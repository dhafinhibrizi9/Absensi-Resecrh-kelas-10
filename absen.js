                ...
                row.innerHTML = `
                    ...
                    <td>
                        <div class="status-buttons">
                            <button class="status-btn present ${status === 'present' ? 'active' : ''}" data-id="${student.id}" data-status="present">H</button>
                            <button class="status-btn permit ${status === 'permit' ? 'active' : ''}" data-id="${student.id}" data-status="permit">I</button>
                            <button class="status-btn absent ${status === 'absent' ? 'active' : ''}" data-id="${student.id}" data-status="absent">A</button>
                        </div>
                    </td>
                `;
